...
const seoTemplates = {
  home: {
    title: "Compare Electricity Rates - Save Up to $800/Year | Electric Scouts",
  ...
  state: {
    titleTemplate: (state) => `${state} Electricity Rates - Compare Plans & Save | Electric Scouts`,
  ...
  city: {
    titleTemplate: (city, state) => `${city} Electricity Rates - Compare ${city}, ${state} Plans | Electric Scouts`,
  ...
  provider: {
    titleTemplate: (provider) => `${provider} Electricity Plans & Rates - Reviews & Comparison | Electric Scouts`,
  ...
  comparison: {
    title: "Compare Electricity Rates - Free Instant Comparison | Electric Scouts",
  ...
  resource: {
    titleTemplate: (topic) => `${topic} - Electricity Guide & Resources | Electric Scouts`,
