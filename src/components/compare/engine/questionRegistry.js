...
export const QUESTIONS = [
  ...
  // ── Commercial branch ──
  {
    ...
    options: [
      ...
      { value: 'restaurant', label: 'Restaurant / hospitality', icon: 'restaurant' },
      { value: 'multifamily', label: 'Multifamily / property management', icon: 'multifamily' },
      { value: 'industrial', label: 'Industrial / manufacturing', icon: 'industrial' },
      { value: 'healthcare', label: 'Healthcare', icon: 'healthcare' },
      { value: 'other', label: 'Other business', icon: 'briefcase' },
    ],
