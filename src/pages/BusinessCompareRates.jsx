      ...
      <SEOHead
        ...
        structuredData={[
          getFAQSchema([
            ...
            { question: "How much can a business save by switching electricity providers?", answer: "It depends entirely on the rate you are on now, and this site holds plan rates rather than your bill — so a percentage quoted here would be invented. What can be said is where a saving comes from. Supply is the only contestable half of a commercial bill, and what a switch can capture is the gap between your current supply rate and the best one quoted to you at the same contract length. Take that difference in cents per kWh from your bill, multiply by your annual kWh, and that is the answer for your business rather than for an average one." }
          ]),
          getBreadcrumbSchema([
            { name: "Home", url: "/" },
