...
export default function NewHampshireElectricity() {
    ...
    faqs: [
      {
        ...
        answer: "New Hampshire has a deregulated electricity market where residents can choose their competitive electricity supplier from competing suppliers. Eversource or Liberty Utilities continues to deliver your electricity and maintain the grid, but you can shop for competitive supply rates from alternative providers."
      },
      {
        id: 2,
        question: "How much can I save on electricity in New Hampshire?",
        answer: "What you save depends on three things: the rate you are paying now, how much electricity you use, and the plan you switch to. Compare your current rate per kWh against the New Hampshire plans listed here — the difference between them, multiplied by your monthly usage, is your actual saving."
      },
      {
        id: 3,
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="New Hampshire Electricity Rates & Providers | Electric Scouts"
        description="Compare 22 New Hampshire electricity plans from 11 suppliers, 9.3¢/kWh–14.49¢/kWh. Rates by city, renewable options and how switching works."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Compare plans from {stateMarket?.providers ?? "the"} suppliers with active New Hampshire plans. What you save depends on your current rate and usage.
            </p>
            ...
            <Card className="border-2 hover:shadow-xl transition-all">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Suppliers price the same New Hampshire power differently. We show what each one
