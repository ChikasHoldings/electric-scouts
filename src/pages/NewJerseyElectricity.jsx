...
export default function NewJerseyElectricity() {
  ...
  const stateProviders = providersInState("NJ").slice(0, 6);
  const renewableHere = renewableProvidersInState("NJ");
            ...
            <Card className="border-2 hover:shadow-xl transition-all">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Suppliers price the same New Jersey power differently. We show what each one
