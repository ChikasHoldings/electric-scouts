...
export default function MarylandElectricity() {
  ...
  const stateMarket = getStateMarket("MD");
  ...
  const stateProviders = providersInState("MD").slice(0, 6);
  const renewableHere = renewableProvidersInState("MD");
  ...
  const stateData = {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "What you save depends on three things: the rate you are paying now, how much electricity you use, and the plan you switch to. Compare your current rate per kWh against the Maryland plans listed here — the difference between them, multiplied by your monthly usage, is your actual saving."
      },
      {
        id: 3,
      ...
      },
      {
        ...
        answer: `Yes. ${stateMarket?.renewablePlans ?? 0} of the ${stateMarket?.plans ?? 0} Maryland plans we track are backed by 100% renewable energy${renewableHere.length ? `, from suppliers including ${renewableHere.slice(0, 3).join(", ")}` : ""}. Renewable supply in a competitive market is normally matched with renewable energy certificates rather than a dedicated line to a wind farm.`
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Maryland Electricity Rates & Providers | Electric Scouts"
        description="Compare 26 Maryland electricity plans from 17 suppliers, 8.4¢/kWh–13.49¢/kWh. Rates by city, renewable options and how switching works."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Compare plans from {stateMarket?.providers ?? "the"} suppliers with active Maryland plans. What you save depends on your current rate and usage.
            </p>
            ...
            <Card className="border-2 hover:shadow-xl transition-all">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Suppliers price the same Maryland power differently. We show what each one
