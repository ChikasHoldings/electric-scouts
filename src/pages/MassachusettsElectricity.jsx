  ...
  const stateData = {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes! Many Massachusetts competitive suppliers offer 100% renewable energy plans. Companies like Verde Energy, Constellation, and Think Energy provide green energy options that support Massachusetts' clean energy goals, often at competitive prices with traditional sources."
      }
    ]
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <nav className="mb-4 text-sm">
              ...
              <span className="mx-2 text-blue-300">/</span>
              <span className="text-white">Massachusetts</span>
            </nav>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-2 hover:shadow-xl transition-all">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Save $710/Year</h3>
                <p className="text-gray-600">
                  Massachusetts residents save an average of $710 annually with competitive suppliers
                </p>
              </CardContent>
            </Card>
