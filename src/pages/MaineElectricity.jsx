...
export default function MaineElectricity() {
  ...
  const stateMarket = getStateMarket("ME");
  ...
  const stateProviders = providersInState("ME").slice(0, 6);
  const renewableHere = renewableProvidersInState("ME");
    ...
    faqs: [
      {
        ...
        answer: "Maine has a deregulated electricity market where residents can choose their competitive electricity provider from competing suppliers. Central Maine Power (CMP) or Versant Power continues to deliver your electricity and maintain the grid, but you can shop for competitive supply rates from alternative providers."
      },
      {
        id: 2,
        question: "How much can I save on electricity in Maine?",
        answer: "What you save depends on three things: the rate you are paying now, how much electricity you use, and the plan you switch to. Compare your current rate per kWh against the Maine plans listed here — the difference between them, multiplied by your monthly usage, is your actual saving."
      },
      {
        id: 3,
      ...
      },
      {
        ...
        answer: `Yes. ${stateMarket?.renewablePlans ?? 0} of the ${stateMarket?.plans ?? 0} Maine plans we track are backed by 100% renewable energy${renewableHere.length ? `, from suppliers including ${renewableHere.slice(0, 3).join(", ")}` : ""}. Renewable supply in a competitive market is normally matched with renewable energy certificates rather than a dedicated line to a wind farm.`
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Maine Electricity Rates & Providers | Electric Scouts"
        description="Compare 22 Maine electricity plans from 11 suppliers, 9.4¢/kWh–16.49¢/kWh. Rates by city, renewable options and how switching works."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Compare plans from {stateMarket?.providers ?? "the"} suppliers with active Maine plans. What you save depends on your current rate and usage.
            </p>
            ...
            <Card className="border-2 hover:shadow-xl transition-all">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Suppliers price the same Maine power differently. We show what each one
